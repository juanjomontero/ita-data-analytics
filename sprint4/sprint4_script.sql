...
-- Creació de les taules, en estrella, amb transactions al centre
    ...
    LOAD DATA LOCAL INFILE "/home/juanjomontero/ITAcademy/SPRINT4/csv/users_ca.csv"
	...
	LOAD DATA LOCAL INFILE "/home/juanjomontero/ITAcademy/SPRINT4/csv/users_uk.csv"
	...
	LOAD DATA LOCAL INFILE "/home/juanjomontero/ITAcademy/SPRINT4/csv/users_usa.csv"
	...
	LOAD DATA LOCAL INFILE "/home/juanjomontero/ITAcademy/SPRINT4/csv/companies.csv"
	...
	LOAD DATA LOCAL INFILE "/home/juanjomontero/ITAcademy/SPRINT4/csv/credit_cards.csv"
	...
	LOAD DATA LOCAL INFILE "/home/juanjomontero/ITAcademy/SPRINT4/csv/transactions.csv"
...
-- Crear una taula per unir transaccions i productes
    ...
    LOAD DATA LOCAL INFILE "/home/juanjomontero/ITAcademy/SPRINT4/csv/products.csv"
	INTO TABLE products
	FIELDS TERMINATED BY ','
	ENCLOSED BY '"'
	LINES TERMINATED BY '\n'
